    ...
    {isLoading ?
      ...
      <div className="px-3 lg:pl-10 lg:px-6">
        <div className="flex flex-wrap items-center gap-3 sm:gap-5 lg:gap-7">
          ...
          <Link to="/subscription-history" className="text-base lg:text-xl font-semibold text-white py-[6px] px-5 sm:px-[30px] rounded-md bg-[#2C7CAC] shadow-[inset_-2px_-2px_5px_0_#104566] active:shadow-[inset_2px_2px_5px_0_#104566]"> Subscription History </Link>
        ...
        {currentPlan && currentPlan.subscriptionName === plans[1].name && <div className="mt-11 p-5 lg:p-[30px] rounded-md bg-background6 mx-auto shadow-[0px_0px_6px_0px_#28236633]">
          ...
          <div className="flex justify-end">
            <button className="text-base lg:text-xl font-semibold text-white bg-ButtonBg py-2 lg:py-3 px-5 lg:px-10 mt-3 text-center w-auto rounded-md shadow-[inset_-2px_-2px_5px_0_#104566] active:shadow-[inset_2px_2px_5px_0_#104566]" onClick={() => setMatrixLimitModalOpen(true)}> Get </button>
          </div>
        </div>}
